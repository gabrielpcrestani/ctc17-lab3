...
hit_rate_dt, confusion_matrix_dt, kappa_statistic_dt = TestDataDecisionTree(tree, test_data)
print("--- DECISION TREE ---")
...
print("\n--- A PRIORI ---")
hit_rate_ap, confusion_matrix_ap, kappa_statistic_ap = TestDataAPriori(test_data)
